package me.aylias.betterspawners.items;
...
public class RandomSpawner extends Item {
...
//    private final Block block;
    ...
    public RandomSpawner(Settings settings) {
        super(settings);
//        this.block = block;
    }
    ...
    public Block getBlock() {
        ...
        if (val < .45) {
            return Main.ZOMBIE_SPAWNER;
        } else if (val < .8) {
            return Main.SKELETON_SPAWNER;
        } else {
            return Main.SPIDER_SPAWNER;
        }
    }
